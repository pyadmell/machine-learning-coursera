...
for i = 1: size(a3,1)
	...
	tmp(y(i)) = 1;
	J = J - (1/m) * (tmp' * log(a3(i,:)') + (1-tmp)' * log( 1 - a3(i,:))');
end
...
%Theta1_grad = (1/m) * (D1' + lambda * [zeros(1,size(Theta1));Theta1(:,2:end)]);
%Theta2_grad = (1/m) * (D2' + lambda * [zeros(1,size(Theta2));Theta2(:,2:end)]);
